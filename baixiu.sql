...
--
-- Host: 127.0.0.1
-- Generation Time: 2018-05-11 04:21:14
-- 服务器版本： 5.7.18
-- PHP Version: 5.6.30
...
(1, '赵敏璇', '624972242@qq.com', '2018-04-04 12:00:00', 'hi,i am zhaominxuan', 'approved', 1, NULL),
(2, 'zhaorunyuan', '415041434@qq.com', '2018-04-05 09:10:00', 'hi i am your bro', 'rejected', 1, NULL),
(3, 'someone', 'www@gmail.com', '2018-04-06 14:10:00', '你好啊，交个朋友好吗？', 'held', 1, NULL),
(4, '赵敏璇', '624972242@qq.com', '2018-04-09 22:22:00', '好', 'held', 1, 3),
(5, '赵敏璇', '624972242@qq.com', '2018-04-09 18:22:00', 'How are you?', 'held', 1, 3),
(6, 'someone', 'www@gmail.com', '2018-04-11 22:22:00', 'I am fine thank you and you?', 'held', 1, 5),
(7, 'zhaorunyuan', '415041434@qq.com', '2018-04-22 09:10:00', '拜拜', 'approved', 1, NULL);
...
(6, 'site_footer', '<p>© XIU主题演示 本站主题由 themebetter 提供</p>'),
(7, 'comment_status', '1'),
...
(1, 'hello-world', '世界，你好', '/uploads/hello-world.jpg', '2018-05-01 08:08:00', '欢迎使用阿里百秀。这是您的第一篇文章。编辑或删除它，然后开始写作吧！', 222, 111, 'published', 1, 1),
(2, 'simple-post-2', '第一篇示例文章', NULL, '2018-05-01 09:00:00', '欢迎使用阿里百秀。这是一篇示例文章', 123, 10, 'drafted', 1, 1),
(3, 'simple-post-3', '第二篇示例文章', NULL, '2018-05-01 12:00:00', '欢迎使用阿里百秀。这是一篇示例文章', 20, 120, 'drafted', 1, 2),
(4, 'simple-post-4', '第三篇示例文章', NULL, '2018-05-01 14:00:00', '欢迎使用阿里百秀。这是一篇示例文章', 40, 100, 'drafted', 1, 3);
...
(1, 'admin', '624972242@qq.com', 'ace2efdf38aef79f4f64d9fe9297a39f', '赵敏璇', '/static/uploads/zmx.jpg', NULL, 'activated'),
(2, 'zhaorunyuan', '415041434@qq.com', '8b06f4b8c3d19392568d86d7b492fb6f', 'zhaorunyuan', '/static/uploads/zry.jpg', NULL, 'activated');
